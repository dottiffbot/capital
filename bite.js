...
function preload(){
	james = loadFont('./assets/VTCJames-Black.otf');
	streetTran = loadFont("./assets/StreetTransvestiteActionRevolutionaries-Regular.otf")
	das = loadFont("./assets/daskapital.ttf")
}
